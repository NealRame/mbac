...
requirejs.config({
    ...
    paths: {
        ...
        'FormDataModelSyncMixin': 'common/ModelMixins/form-data-model-sync',
        'LightBox': 'common/LightBox/lightbox',
        'Picture': 'common/Picture/picture',
        'PictureList': 'common/PictureList/picture-list',
        'PicturesContainerMixin': 'common/ModelMixins/pictures-container',
        'PublishStateMixin': 'common/ModelMixins/publish-state',
        'TabbedPanels': 'common/TabbedPanels/tabbedpanels',
        'TagsContainerMixin': 'common/ModelMixins/tags-container',
